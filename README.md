...
2. **Ejecuta la aplicación**:
   - Busca la clase principal [`com.pdp.gr02.buscasumas.MainApp`](src/main/java/com/pdp/gr02/buscasumas/MainApp.java).
...
![Pantalla principal](/src/main/resources/images/docs/image1.png)

### Juego en progreso

![Juego en progreso](/src/main/resources/images/docs/image2.png)
